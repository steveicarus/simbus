...
void
simbus_mt_sgenrand(struct simbus_mt_context_s *context, unsigned long seed)
{
...
unsigned long
simbus_mt_genrand(struct simbus_mt_context_s *context)
{
    unsigned long y;
	...
	static unsigned long mag01[2]={0x0, MATRIX_A};
        ...
        if (mti == N+1)   /* if sgenrand() has not been called, */
            simbus_mt_sgenrand(context, 4357); /* a default initial seed is used   */
